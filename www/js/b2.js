...
console.log(splitString);
        resultDiv.innerHTML = "Humo = "+splitString[0]+"<br>Luz = "+splitString[2]+"<br>Temperatura = "+splitString[4]+"<br>Movimiento = "+splitString[6]+"<br>Humedad = "+splitString[8];
        ;
    },
